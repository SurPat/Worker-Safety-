...
def cam2():
    ...
    #rootpath = "C:\\Users\\99006638\\PycharmProjects\\pythonProject\\social_distance\\Test_videos\\vids\\cam2"
    #vidlist = os.listdir(rootpath)
   # print(vidlist)
    ...
    for i in vidlist:
        if '.mp4' in i:
           # process = psutil.Process(os.getpid())
            ...
            ########################
            # fourcc =
            #vidpath = rootpath + '\\result\\'
            # os.mkdir(vidpath+"\\video")
            out_vid = cv2.VideoWriter(vidpath + fname + "result.avi", cv2.VideoWriter_fourcc('M', 'J', 'P', 'G'), FPS,
            ...
            while True:
                ...
                try:
                    ...
                    cv2.setWindowProperty("cam2", cv2.WND_PROP_TOPMOST,1)
